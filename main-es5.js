...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _components_job_list_job_list_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./components/job-list/job-list.component */
    ...
    AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      directives: [_components_header_header_component__WEBPACK_IMPORTED_MODULE_1__["HeaderComponent"], _components_job_list_job_list_component__WEBPACK_IMPORTED_MODULE_2__["JobListComponent"]],
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _components_job_list_job_list_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./components/job-list/job-list.component */
    "./src/app/components/job-list/job-list.component.ts");
    /* harmony import */


    var _components_single_job_single_job_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./components/single-job/single-job.component */
  ...
  function srcAppComponentsHeaderHeaderComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    HeaderComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 11,
      vars: 0,
      consts: [[1, "container"], ["href", "/", 1, "header-link"], ["src", "assets/img/logo-w.svg", "alt", ""], [1, "options"], ["id", "filter"], ["src", "assets/img/icons/filter.svg", "alt", ""], ["id", "search"], ["src", "assets/img/icons/search.svg", "alt", ""]],
  ...
  /***/
  function srcAppComponentsJobListJobListComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _single_job_single_job_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../single-job/single-job.component */
    "./src/app/components/single-job/single-job.component.ts");

    var _c0 = ["jobListElement"];

    function JobListComponent_app_single_job_4_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var JobListComponent = /*#__PURE__*/function () {
      function JobListComponent(portfolioService) {
      ...
      _createClass(JobListComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.portfolioService.fetchPortfolioData().subscribe(function (response) {
            var _this$jobList, _this$jobList2;

            response.data ? (_this$jobList = _this.jobList).push.apply(_this$jobList, _toConsumableArray(response.data)) : (_this$jobList2 = _this.jobList).push.apply(_this$jobList2, _toConsumableArray(response));
          });
        }
      }, {
        key: "ngAfterViewInit",
        value: function ngAfterViewInit() {
          ...
          window.addEventListener('wheel', function (event) {
            _this2.captureScroll(event);
          }, false);
        }
      }, {
        key: "captureScroll",
        value: function captureScroll(event) {
    ...
    JobListComponent.ɵfac = function JobListComponent_Factory(t) {
      return new (t || JobListComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_portfolio_service__WEBPACK_IMPORTED_MODULE_1__["PortfolioService"]));
    };
    ...
    JobListComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 5,
      vars: 1,
      consts: [["mainElement", ""], ["jobListElement", ""], [3, "job", "jobIndex", 4, "ngFor", "ngForOf"], [3, "job", "jobIndex"]],
      ...
      directives: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["NgForOf"], _single_job_single_job_component__WEBPACK_IMPORTED_MODULE_3__["SingleJobComponent"]],
  ...
  /***/
  function srcAppComponentsSingleJobSingleJobComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "SingleJobComponent", function () {
    ...
    var SingleJobComponent = /*#__PURE__*/function () {
      function SingleJobComponent() {
        _classCallCheck(this, SingleJobComponent);
      }

      _createClass(SingleJobComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
    ...
    SingleJobComponent.ɵfac = function SingleJobComponent_Factory(t) {
      return new (t || SingleJobComponent)();
    };

    SingleJobComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: SingleJobComponent,
      selectors: [["app-single-job"]],
      inputs: {
        job: "job",
        jobIndex: "jobIndex"
      },
      decls: 11,
      vars: 7,
      consts: [["target", "_blank", 3, "href", "ngStyle"], [1, "white"], [1, "content"], [1, "text"], [1, "index"], [1, "type"]],
      template: function SingleJobComponent_Template(rf, ctx) {
        if (rf & 1) {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](SingleJobComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  function srcAppServicesPortfolioServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var PortfolioService = /*#__PURE__*/function () {
      ...
      _createClass(PortfolioService, [{
        key: "fetchPortfolioData",
        value: function fetchPortfolioData() {
          var _this3 = this;

          return this.getPortfolioData.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["catchError"])(function () {
            console.error('Failed to fetch portfolio data. Using backup JSON');
            return _this3.getBackupPortfolioData;
          }));
        }
      }, {
        ...
        key: "getBackupPortfolioData",
        get: function get() {
          return this.http.get('data/backup-portfolio.json');
        }
      }]);
    ...
    PortfolioService.ɵfac = function PortfolioService_Factory(t) {
      return new (t || PortfolioService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]));
    };
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /Users/ricardogouveia3/Dev/rcrd-portfolio/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
