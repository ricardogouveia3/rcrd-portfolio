...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    var JobListComponent = /*#__PURE__*/function () {
      ...
      _createClass(JobListComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.portfolioService.getPortfolioData().subscribe(function (response) {
            var _this$jobList;

            (_this$jobList = _this.jobList).push.apply(_this$jobList, _toConsumableArray(response.data));
          });
        }
      }, {
        key: "ngAfterViewInit",
  ...
  function srcAppServicesPortfolioServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    PortfolioService.ɵfac = function PortfolioService_Factory(t) {
      return new (t || PortfolioService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"]));
    };
